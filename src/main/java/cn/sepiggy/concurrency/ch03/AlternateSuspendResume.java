package cn.sepiggy.concurrency.ch03;
...
public class AlternateSuspendResume extends Object implements Runnable {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            // 让线程有机会注意到挂起请求
            // 注意：这里休眠时间一定要大于
            //stepOne 操作对 firstVal 赋值后的休眠时间，即 300ms，
            // 目的是为了防止在执行 asr.areValuesEqual（）进行比较时,
            // 恰逢 stepOne 操作执行完，而 stepTwo 操作还没执行
            try {
                Thread.sleep(350);
            } catch (InterruptedException x) {
            }
